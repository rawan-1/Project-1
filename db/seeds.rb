...
Appliance.create(name: "Mixer1", image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQQXYbI4u6Jk6bvo-Jr6lNKdVG4on5djmnIKRB8PVu5oVyNIC91xA", description: "KitchenAid Tilt-Head Stand Mixer
4-1/2 quart and stainless steel bowl w/flat handle", availability: "true", customer_id: user1.id, provider_id: user2.id)

Appliance.create(name: "Mixer3", image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQQXYbI4u6Jk6bvo-Jr6lNKdVG4on5djmnIKRB8PVu5oVyNIC91xA", description: "KitchenAid Tilt-Head Stand Mixer
4-1/2 quart and stainless steel bowl w/flat handle", availability: "true", customer_id: user1.id, provider_id: user2.id)
